...
inputFile = open("/media/fahim/New Volume/Fall2021/CSE422/Lab2/q1")
# inputFile = open("/media/fahim/New Volume/Fall2021/CSE422/Lab2/q2")
...
def crossOver(x,y):
  ...
  idx = r.randrange(0,chromosome_len)
  # print(idx)
...
def randomSelect(population):
  x = r.randint(0,len(population)-1)
  y = r.randint(0,len(population)-1)
  while y == x:
    y = r.randint(0,len(population)-1)
  ...
  for j in range(0,15000):
    ...
    for i in range(len(parentPopulation)):
      ...
      if fitness_fn(child) == 0:
        ...
        found = True
        break
      elif fitness_fn(child) <= 300 and fitness_fn(child) >=-300:
